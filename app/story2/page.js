...
const DragAndDropTask = dynamic(() => import("../components/dragAndDropTask"), {
  ssr: false,
});
...
export default function StoryTwo() {
  ...
  // Update page title
  useEffect(() => {
    document.title = "Story 2 - The Kingdom of Lost Words";
  }, []);
  ...
  const selectedStoryName = "The Kingdom of Lost Words";
